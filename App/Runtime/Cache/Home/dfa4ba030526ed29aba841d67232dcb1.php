...
<head>
    ...
    <link rel="stylesheet" href="/Public/Home/css/interview.css">
    ...
    <script src="/Public/Home/js/interview.js"></script>
</head>
<body>
            ...
            <div class="INCon">
                <div class="container">
                    <div class="main_inter">
                        <div class="inters">
                            <!--<div class="inters col-lg-9 col-md-9 col-sm-12 col-xs-12">-->
                            <div class="main-inters-title">
                                <div class="main-interSplit">
                                    <div class="interSplit"></div>
                                    <span>深度专访</span>
                                </div>
                            </div>
                            <div class="main-inters-con">
                                <ul class="main-interviewCon">
                                    <!--动态创建-->
                                </ul>
                            </div>
                        </div>
                        <!--<div class="interAds col-lg-3 col-md-3 hidden-sm hidden-xs">-->
                            <!--<div class="interAd">-->
                                <!--<a href="#">-->
                                    <!--<img src="/Public/Home/images/VNImg/video.jpg" alt="我是广告图">-->
                                <!--</a>-->
                            <!--</div>-->
                        <!--</div>-->
                    </div>
